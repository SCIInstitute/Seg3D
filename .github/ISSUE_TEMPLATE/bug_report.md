...
You can get this information from executing `Seg3D --version` at the command line, or the top bar of the GUI (which copies the version to the clipboard). Also, please include the OS and what version of the OS you're running.
