...
foreach(lib ${SCI_BOOST_LIBRARY})
  ...
  elseif(APPLE OR UNIX)
    if(${lib} MATCHES "boost_python-mt")
      set(FULL_LIB_NAME "${SCI_BOOST_LIBRARY_DIR}/${boost_LIB_PREFIX}boost_python${SCI_PYTHON_VERSION_SHORT}-mt-${PLATFORM_SUFFIX}${CMAKE_STATIC_LIBRARY_SUFFIX}")
    else()
    ...
    if(${lib} MATCHES "boost_python-mt")
      if(WIN32)
        set(FULL_LIB_NAME_RELEASE "${SCI_BOOST_LIBRARY_DIR}/${boost_LIB_PREFIX}boost_python${SCI_PYTHON_VERSION_SHORT}-mt-x64${CMAKE_STATIC_LIBRARY_SUFFIX}")
        set(FULL_LIB_NAME_DEBUG "${SCI_BOOST_LIBRARY_DIR}/${boost_LIB_PREFIX}boost_python${SCI_PYTHON_VERSION_SHORT}-mt${DEBUG_POSTFIX}-x64${CMAKE_STATIC_LIBRARY_SUFFIX}")
      else()
        set(FULL_LIB_NAME_RELEASE "${SCI_BOOST_LIBRARY_DIR}/${boost_LIB_PREFIX}boost_python${SCI_PYTHON_VERSION_SHORT}-mt${CMAKE_STATIC_LIBRARY_SUFFIX}")
        set(FULL_LIB_NAME_DEBUG "${SCI_BOOST_LIBRARY_DIR}/${boost_LIB_PREFIX}boost_python${SCI_PYTHON_VERSION_SHORT}-mt${DEBUG_POSTFIX}${CMAKE_STATIC_LIBRARY_SUFFIX}")
      endif()
